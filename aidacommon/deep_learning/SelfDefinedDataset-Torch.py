...
def trainingLoop(dw):
    ...
    #200000
    logging.info('The execution time on GPU for a dataset of size 10000 and 10000 epochs using Pytorch is: '+str(execution_time))
    return_mesg = "The execution time on GPU for a dataset of size 10000 and 10000 epochs using Pytorch is:" + str(execution_time)
    # In[127]:
