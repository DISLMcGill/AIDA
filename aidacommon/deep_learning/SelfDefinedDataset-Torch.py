...
def trainingLoop(dw):
    ...
    #2000000
    logging.info('The execution time on GPU for a dataset of size 100000 and 100000 epochs using Pytorch is: '+str(execution_time))
    return_mesg = "The execution time on GPU for a dataset of size 100000 and 100000 epochs using Pytorch is:" + str(execution_time)
    # In[127]:
